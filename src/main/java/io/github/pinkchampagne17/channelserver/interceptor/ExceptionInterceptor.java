...
public class ExceptionInterceptor {
    ...
    public ResponseEntity<ErrorResponse> ExceptionHandler(HttpServletRequest request, Exception e) {
        ...
        var response = new ErrorResponse(HttpStatus.INTERNAL_SERVER_ERROR, ErrorCode.UNKNOWN_ERROR, "unknown error.");
        return ResponseEntity.internalServerError().body(response);
    }

    @ExceptionHandler(ErrorResponse.class)
    public ResponseEntity<ErrorResponse> ErrorResponse(ErrorResponse e) {
